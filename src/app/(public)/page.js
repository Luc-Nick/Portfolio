...
export default function Home() {
  return (
    <div className="relative bg-slate-950 w-full font-sans grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20">
      <div className="
        pointer-events-none
        absolute inset-0 -top-16 left-1/2 lg:-ml-[310px]
        lg:w-[620px] h-40
        bg-blue-700
        opacity-50
        blur-3xl
